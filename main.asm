...
INVOKE REAdFILE,FILEHANDLE,ADDR lDISP3,8,ADDR noofbytes,NULL
INVOKE SETFILEPOINTER,FILEHANDLE,0,0,FILE_CURRENT
INVOKE READFILE,FILEHANDLE,ADDR lDISP4,1,ADDR noofbytes,NULL
INVOKE READFILE,FILEHANDLE,ADDR lDISP4,4,ADDR noofbytes,NULL
mov ecx, sizeof lDISP4
mov ebx, 0
l1:
...
MOV EDX,OFFSET lDISP3
CALL WRITESTRING
CALL CRLF
MOV EDX,OFFSET lDISP4
CALL WRITESTRING
CALL CRLF
...
ret
tostring endp
;manual combo when there is no combo it wll unexchange
manualcombo proc 
